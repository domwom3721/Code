...
def PopulationAgeLanguage():
    ...
    try:
        age_ranges = [' children & teens',' young adults',' young professionals',' those between 35 and 49 years old',' those between 50 and 66 years old',' those over 67 years old']
