...
def GetCensusFrequencyDistribution(geographic_level,hood_or_comparison_area,fields_list):
...
def GetData():
    ...
    print(neighborhood_household_size_distribution)
