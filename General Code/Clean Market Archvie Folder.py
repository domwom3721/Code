...
market_archive_root                   =  os.path.join(os.environ['USERPROFILE'], 'Dropbox (Bowery)','Research','Market Analysis','Market','Archive','2021 Q3') 
...
for (dirpath, dirnames, filenames) in os.walk(market_root):
    ...
    for file in filenames:
        if ('2021 Q4' in file): #skip files that are for the most current quarter
            continue
